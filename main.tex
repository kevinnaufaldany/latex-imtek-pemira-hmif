...
\newcommand{\dokumen}{GUIDE BOOK PEMILIHAN}
...
\subsection*{Header Tanpa Penomoran}
     Untuk menggunakan subheader tanpa penomoran, anda cukup membuat $\backslash${\tt{subsection*}} atau bahkan \\
     $\backslash${\tt{subsubsection*}} maupun $\backslash${\tt{section*}}.
